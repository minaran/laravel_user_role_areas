<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links     dodali smo za tichera Timetable a obrisali za d a s h b o a r d -->
    ...
    <!-- Responsive Navigation Menu i ovde dodajemo za teachera Timetable, a obrisali za D a s h b o r d-->
